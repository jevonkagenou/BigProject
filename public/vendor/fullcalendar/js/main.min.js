...
var FullCalendar = (function (e) {
    ...
    var qr = (function (e) {
        ...
        return (
            ...
            (t.prototype.shouldComponentUpdate = function (e, t) {
                return (
                    this.debug &&
                        console.log(Fe(e, this.props), Fe(t, this.state)),
    ...
    var na = (function (e) {
        ...
        return (
            ...
            (t.prototype.computeShrinkWidth = function () {
                return Ki(this.props.cols)
                    ? Bi(this.scrollerElRefs.getAll())
                    : 0;
            }),
    ...
    var ca = (function (e) {
        function t() {
            var t = (null !== e && e.apply(this, arguments)) || this;
            return (
                (t.refineHookProps = lt(ua)), (t.normalizeClassNames = yo()), t
            );
        }
        return (
            n(t, e),
        ...
        Sa = (function () {
            function e(e) {
                ...
                (this.subjectEl = null),
                    ...
                    1 === (ya += 1) &&
                        window.addEventListener("touchmove", Da, {
                            passive: !1,
                        });
            }
            return (
                (e.prototype.destroy = function () {
                    this.containerEl.removeEventListener(
                        ...
                        (ya -= 1) ||
                            window.removeEventListener("touchmove", Da, {
                                passive: !1,
                            });
                }),
                (e.prototype.tryStart = function (e) {
                    ...
                    return (
                        !(
                            !t ||
                            (this.handleSelector && !z(n, this.handleSelector))
                        ) &&
                        ((this.subjectEl = t),
                        (this.isDragging = !0),
                        (this.wasTouchScroll = !1),
            ...
            return (
                ...
                (e.prototype.computeTimeTop = function (e) {
                    var t,
                        ...
                        i = r.els.length,
                        a =
                            (e.milliseconds - et(o.slotMinTime)) /
                            et(this.slotDuration);
                    return (
                        (a = Math.max(0, a)),
                        (a = Math.min(i, a)),
                        (t = Math.floor(a)),
                                ...
                                r(
                                    {
                                        ...
                                        isCondensed:
                                            e.bottom - e.top <
                                            vi.timeGridEventCondensedHeight,
                                    },
    ...
    var Ks = (function (e) {
        function t() {
            var t = (null !== e && e.apply(this, arguments)) || this;
            return (
                (t.buildTimeColsModel = st(Js)), (t.buildSlatMetas = st(Xs)), t
            );
        }
        return (
            n(t, e),
                ...
                return Ar(Pi, { unit: "day" }, function (e, n) {
                    for (var s = [], l = 0; l < a.length; l += 1) {
                        ...
                        if (u) {
                            ...
                            s.push(
                                Ar(Qs, { key: c, dayDate: t[l], todayRange: n })
                            );
                            for (
