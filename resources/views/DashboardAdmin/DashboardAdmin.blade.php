                                    ...
                                    <div class="tab-content">
                                        <div class="text-center">
                                            <span class="border border-secondary">
                                                <h4 class="text text-black" style="color:#969ba0 !important;">Total
                                                    Gaji
                                                    Karyawan
                                                </h4>
                                                <h4 class="text text-black" style="color:#969ba0 !important;">
                                                    <strong>Rp
                                                        6.500.000</strong>
                                                </h4>
                                                <h5 class="text text-danger"><strong><svg
                                        ...
                                        <div class="text-center">
                                            <span class="border border-secondary">
                                                <h4 class="text text-black" style="color:#969ba0 !important;">Rata -
                                                    Rata Gaji
                                                    Bulan
                                                    Ini
                                                </h4>
