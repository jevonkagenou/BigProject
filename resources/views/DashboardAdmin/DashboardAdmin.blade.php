        ...
        <div class="dlabnav">
            <div class="dlabnav-scroll mm-active ps ps--active-y">
                <ul class="metismenu mm-show" id="menu">
                    ...
                    <li class="mm-active"><a class="ai-icon hover-red  mm-active" href="/" aria-expanded="false">
                            <svg class="red-icon" xmlns="http://www.w3.org/2000/svg" style="font-size: 80px !important"
