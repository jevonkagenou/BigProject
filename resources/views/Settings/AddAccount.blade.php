                        ...
                        <ul class="navbar-nav header-right">
                            <li class="nav-item dropdown">
                                ...
                                <ul class="dropdown-menu dropdown-menu-end" style="margin-left:-100%;">
                                    <li><a class="dropdown-item" href="#"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="#969ba0" viewBox="0 0 448 512" style="margin-left: 10px; margin-bottom: 5px; padding-right:5px">
            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            @foreach ($data as $row)
                            <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-4 mb-4">
                                <div class="card h-100 text-center" style="border: solid black 1px;">
                                    <div class="card-body d-flex flex-column justify-content-center">
                                        @if ($row->nama_bank=='Mandiri')
                                            <img src="{{asset('gambar/MANDIRI.png')}}" alt="">
                                            @elseif ($row->nama_bank=='BRI')
                                            <img src="{{asset('gambar/BRI.jpg')}}" alt="">
                                            @elseif ($row->nama_bank=='Bank Jatim')
                                            <img src="{{asset('gambar/BANK JATIM.png')}}" alt="">
                                            @elseif ($row->nama_bank=='BCA')
                                            <img src="{{asset('gambar/BCA.png')}}" alt="">
                                        @else

                                        @endif
                                        <img src="{{ asset($row->foto) }}" alt="">
                                    </div>
                                    <p class="card-text">{{ $row->nama_bank }}</p>
                                    <p class="card-text">{{ $row->no_reg }}</p>
                                </div>
                            </div>
                            @endforeach
                            ...
                            <form action="/InsertAccount" method="post" enctype="multipart/form-data">
                                <div class="modal-body">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select class="default-select form-control wide mb-3" name="nama_bank" ">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="number" class="form-control" name="no_reg" placeholder="Nomor Rekening Bank" required="">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-1 col-md-2 col-lg-2">
                                            <button class="btn btn-outline-danger btn-xs ms-1" type="submit" style="white-space: nowrap;">Simpan</button>
                                        </div>
                                    </div>
                                </div>
                            </form>
