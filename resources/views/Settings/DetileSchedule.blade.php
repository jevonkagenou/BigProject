                ...
                <div class="row">
                    ...
                    <div class="row page-titles">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="">Jadwal Kerja</a></li>
                            <li class="breadcrumb-item"><svg xmlns="http://www.w3.org/2000/svg" width="16"
                                    height="16" fill="#f72b50" class="bi bi-play-fill" viewBox="0 0 16 16">
                                    <path
                                        d="m11.596 8.697-6.363 3.692c-.54.313-1.233-.066-1.233-.697V4.308c0-.63.692-1.01 1.233-.696l6.363 3.692a.802.802 0 0 1 0 1.393z" />
                                </svg></li>
                            <li class="breadcrumb-item active"><a href="">Detail Jadwal Kerja</a></li>
                        </ol>
                    </div>
                            ...
                            <div class="card-body mb-5">
                                <div class="row mb-3">
                                    ...
                                    <div class="col-lg-2 col-6 text-end">
                                        <a type="button" href="/SettingSchedule" class="btn btn-warning btn-xs"><i
                                ...
                                <div class="card border border-dark">
                                    ...
                                    <div class="text-black">
                                        <div class="row border-bottom mb-3 align-items-center">
                                            <div class="col-xl-8 col-6">
                                                <h5 class="fw-bold">Jadwal Kantor</h5>
                                            </div>
                                    ...
                                    <div class="row mb-2">
                                        ...
                                        <h6 class="card-text text-dark">Tanggal Efektif</h6>
                                        <p class="card-text text-black">02/06/2023</p>
                                        </div>
                                            <div class="col-lg-4 col-6">
                                                <h6 class="card-text text-dark">Hari Kerja</h6>
                                                <p class="card-text text-black">5</p>
                                            </div>
                                            <div class="col-lg-4 col-6">
                                                <h6 class="card-text text-dark">Hari Libur</h6>
