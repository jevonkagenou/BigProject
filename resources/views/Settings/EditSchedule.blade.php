            ...
            <div class="dlabnav-scroll">
                <ul class="metismenu" id="menu">
                    <li class="dropdown header-profile">
                        ...
                        <div class="dropdown-menu dropdown-menu-end">
                            <a href="app-profile.html" class="dropdown-item ai-icon">
                                <svg class="svg" id="icon-user1" xmlns="http://www.w3.org/2000/svg"
                            ...
                            <a href="/Login" class="dropdown-item ai-icon">
                                <svg class="svg" id="icon-logout" xmlns="http://www.w3.org/2000/svg"
                    ...
                    <li><a class="ai-icon hover-red" href="/DashboardAdmin" aria-expanded="false">
                            <svg class="svg" class="svg" xmlns="http://www.w3.org/2000/svg"
                    ...
                    <li class="mm-active"><a class=" ai-icon hover-red" href="/Setting" aria-expanded="false">
                            <svg class="red-icon" class="red-icon" xmlns="http://www.w3.org/2000/svg" height="48"
                                viewBox="0 -960 960 960" width="48">
                                <path
                ...
                <div class="row">
                    ...
                    <div class="row page-titles">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="/WorkSchedule">Jadwal Kerja</a></li>
                            <li class="breadcrumb-item"><svg xmlns="http://www.w3.org/2000/svg" width="16"
                                    height="16" fill="#f72b50" class="bi bi-play-fill" viewBox="0 0 16 16">
                                    <path
                                        d="m11.596 8.697-6.363 3.692c-.54.313-1.233-.066-1.233-.697V4.308c0-.63.692-1.01 1.233-.696l6.363 3.692a.802.802 0 0 1 0 1.393z" />
                                </svg></li>
                            <li class="breadcrumb-item"><a href="/DetileSchedule">Detail Jadwal Kerja</a></li>
                            <li class="breadcrumb-item"><svg xmlns="http://www.w3.org/2000/svg" width="16"
                                height="16" fill="#f72b50" class="bi bi-play-fill" viewBox="0 0 16 16">
                                <path
                                    d="m11.596 8.697-6.363 3.692c-.54.313-1.233-.066-1.233-.697V4.308c0-.63.692-1.01 1.233-.696l6.363 3.692a.802.802 0 0 1 0 1.393z" />
                            </svg></li>
                        <li class="breadcrumb-item active"><a href="/EditSchedule">Edit Jadwal Kerja</a></li>
                        </ol>
                    </div>
                            ...
                            <div class="card-body mb-5">
                                <div class="row mb-3">
                                    ...
                                    <div class="col-lg-2 col-6 text-end">
                                        <a type="button" href="/DetileSchedule" class="btn btn-warning btn-xs"><i
                                                class="bi bi-arrow-left px-1"></i>Kembali</a>
                                    </div>
                                </div>
                                        <div class="col-lg-8 col-12">
                                            <ul class="list-group list-group-flush">
                                                <li class="list-group-item">
                                                    <form>
                                                        <div class="mb-3">
                                                          <label for="exampleInputEmail1" class="form-label">Nama Jadwal</label>
                                                          <input type="email" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Nama Jadwal" value="Jam Kantor">
                                                        </div>
                                                    </form>
                                                </li>
                                                ...
                                                <li class="list-group-item">
                                                    <div class="col-lg-3 col-12">
                                                        <a class="btn btn-outline-danger btn-xs" href="" type=""><svg xmlns="http://www.w3.org/2000/svg" width="17" height="17" fill="currentColor" class="bi bi-plus" viewBox="0 0 16 16">
                                                ...
                                                {{-- <li class="list-group-item">
                                                    <form>
                                                        <div class="row align-items-center">
                                                            <div class="col-6">
                                                                <label for="exampleInputEmail1" class="form-label">Berlaku efektif mulai tanggal</label>
                                                            </div>
                                                            <div class="col-5">
