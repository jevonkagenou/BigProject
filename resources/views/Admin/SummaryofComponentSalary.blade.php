            ...
            <div class="dlabnav-scroll mm-active ps ps--active-y">
                <ul class="metismenu mm-show" id="menu">
                    ...
                    <li class="mm-active"><a class=" ai-icon hover-red mm-active" href="AdminReport" aria-expanded="false">
                        <svg class="red-icon " xmlns="http://www.w3.org/2000/svg" height="48" viewBox="0 -960 960 960" width="48"><path d="M349-250h262q12.75 0 21.375-8.675 8.625-8.676 8.625-21.5 0-12.825-8.625-21.325T611-310H349q-12.75 0-21.375 8.675-8.625 8.676-8.625 21.5 0 12.825 8.625 21.325T349-250Zm0-170h262q12.75 0 21.375-8.675 8.625-8.676 8.625-21.5 0-12.825-8.625-21.325T611-480H349q-12.75 0-21.375 8.675-8.625 8.676-8.625 21.5 0 12.825 8.625 21.325T349-420ZM220-80q-24 0-42-18t-18-42v-680q0-24 18-42t42-18h336q12.444 0 23.722 5T599-862l183 183q8 8 13 19.278 5 11.278 5 23.722v496q0 24-18 42t-42 18H220Zm331-584v-156H220v680h520v-494H581q-12.75 0-21.375-8.625T551-664ZM220-820v186-186 680-680Z"/></svg>
                                                ...
                                                <div class="basic-dropdown">
                                                    <div class="dropdown">
                                                        <button type="button" class="btn btn-outline-light btn-xs dropdown-toggle" data-bs-toggle="dropdown">
                                                            <span><i class="bi bi-arrow-bar-up px-1"></i></span>
                                                            Ekspor
                                                        </button>
                                                        <div class="dropdown-menu">
                                                            <a class="dropdown-item" href="#">
                                                                <span class="px-2"><i class="bi bi-file-earmark-excel"></i></span>XCLS
                                                            </a>
                                                            <a class="dropdown-item" href="#">
                                                                <span class="px-2">
