                            ...
                            <div class="card-body contacts_body p-0 dlab-scroll  " id="dlab_W_Contacts_Body">
                                <ul class="contacts">
                                    ...
                                    <li class="dlab-chat-user">
                                        <div class="d-flex bd-highlight">
                                            <div class="img_cont">
                                                <img src="asset('images/avatar/2.jpg')" class="rounded-circle user_img" alt="Avatar2" />
                                    ...
                                    <li class="dlab-chat-user">
                                        <div class="d-flex bd-highlight">
                                            <div class="img_cont">
                                                <img src="{{ asset('images/avatar/3.jpg') }}" class="rounded-circle user_img" alt="Avatar3" />
                                                <span class="online_icon"></span>
                                            </div>
                                            <div class="user_info">
                        ...
                        <ul class="navbar-nav header-right">
                            <li class="nav-item dropdown">
                                ...
                                <ul class="dropdown-menu dropdown-menu-end" style="margin-left:-100%;">
                                    <li><a class="dropdown-item" href="/ProfilAdmin/1"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="#969ba0" viewBox="0 0 448 512" style="margin-left: 10px; margin-bottom: 5px; padding-right:5px">
            ...
            <div class="dlabnav-scroll mm-active ps ps--active-y">
                <ul class="metismenu mm-show" id="menu">
                    ...
                    <li><a class="ai-icon hover-red" href="/PermitLeaveAdmin" aria-expanded="false">
                            <svg class="svg" xmlns="http://www.w3.org/2000/svg" height="48" viewBox="0 -960 960 960" width="48">
                                <path d="M121-120v-60h720v60H121Zm63-208L81-503l43-8 70 62 226-61-171-287 58-17 285 257 216-58q27-8 49 9.5t22 46.5q0 19-11.5 34T838-505L184-328Z" /></svg>
                            <span class="nav-text ">Izin Cuti</span>
                        </a>
                    </li>
                    <li class="mm-active"><a class=" ai-icon hover-red mm-active" href="AdminReport" aria-expanded="false">
            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><svg xmlns="http://www.w3.org/2000/svg" width="16"
                                height="16" fill="#f72b50" class="bi bi-play-fill" viewBox="0 0 16 16">
                                <path
                                        ...
                                        <div class="col-xl-10 col-lg-10 col-md-10 col-sm-8 col-8 mb-2">
                                            <div class="responsive-button">
                                                <button type="button" class="btn btn-outline-light btn-xs">
                                                    05/2023 - 06/2023<span><i
                                                            class="bi bi-calendar-check px-2"></i></span>
                                                </button>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="table-responsive text-center">
                                    <table id="example6" class="display" style="min-width: 845px">
                                        ...
                                        <tbody>
                                            ...
                                            <tr class="text-center">
                                                <td>{{ $row->id }}</td>
                                                <td>{{ $row->slip_gaji->name }}</td>
                                                <td>{{ \Carbon\Carbon::parse($row->slip_gaji->periode_dimulai)->format('d M Y') }}</td>
                                                {{-- <td>{{ \Carbon\Carbon::createFromFormat('Y-m-d', $row->slip_gaji->periode_dimulai )->format('d M Y') }}</td> --}}
                                                {{-- <td>{{ $totalGajiPokokDanUangLembur }}</td> --}}
                                                <td>{{ $totalGaji }}</td>
                                            </tr>
                                            @endforeach
                                        </tbody>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Ringkasan Komponen Pendapatan</h4>
                            </div>
                            <div class="card-body">
                                ...
                                <div class="table-responsive text-center">
                                    <table id="example8" class="display" style="min-width: 845px">
                                        <thead>
                                            <tr class="text-center">
                                                <th>Slip</th>
                                                <th>Nama Komponen Pendapatan</th>
                                                <th>Uang Pendapatan</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            @foreach ($tabel2 as $row)
                                                <tr class="text-center">
                                                    <td>{{ $row->slip_gaji->name }}</td>
                                                    <td>{{ $row->nama_komponendpt }}</td>
                                                    <td>{{ $row->uang_dapat }}</td><td></td>
                                                </tr>
                                            @endforeach
                                        </tbody>
                                    </table>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Ringkasan Komponen Pemotongan</h4>
                            </div>
                            <div class="card-body">
                                <div class="table-responsive text-center">
                                    <table id="example5" class="display" style="min-width: 845px">
                                        <thead>
                                            <tr class="text-center">
                                                <th>Slip</th>
                                                <th>Nama Komponen Pemotongan</th>
                                                <th>Uang Komponen Potong</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            @foreach ($tabel3 as $row)
                                                <tr class="text-center">
                                                    <td>{{ $row->slip_gaji->name }}</td>
                                                    <td>{{ $row->nama_komponenptg }}</td>
                                                    <td>{{ $row->uang_potong }}</td>
                                                </tr>
                                            @endforeach
                                        </tbody>
                                    </table>
