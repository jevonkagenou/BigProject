...
<div id="preloader">
                    ...
                    <li class="dropdown header-profile">
                        ...
                        <div class="dropdown-menu dropdown-menu-end">
                            <a href="app-profile.html" class="dropdown-item ai-icon">
                                <svg class="svg" id="icon-user1" xmlns="http://www.w3.org/2000/svg" class="text-primary"
                            ...
                            <a href="/Login" class="dropdown-item ai-icon">
                                <svg class="svg" id="icon-logout" xmlns="http://www.w3.org/2000/svg" class="text-danger"
                                    width="18" height="18" viewBox="0 0 24 24" fill="none"
                                    stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                    stroke-linejoin="round">
                ...
                <div class="row">
					...
					<div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-xl-10 col-lg-10 col-md-12 col-sm-12 col-15 btn-group btn-xs">
                                    ...
                                    <div class="col-xl-2 col-lg-2 col-md-12 col-sm-6 col-12 mt-1">
                                        <div class="input-group responsive-button float: right;">
                                            <a type="button" class="btn btn-square btn-outline-light btn-xs" href="/PermitLeaveAdmin">Liat Pengajuan</a>
                                        </div>
                                    </div>
                                </div>
										...
										<table id="example5" class="display" style="min-width: 845px">
											...
											<tbody>
												<tr>
													...
													<td>1</td>
													<td>Amel</td>
													<td>2 <i id="icon" class="fas fa-pencil-alt" style="cursor: pointer"></i>
                                                        <input type="text" id="inputField" class="form-control" autofocus>
                                                    </td>
													<td>5</td>
												...
												<tr>
													...
													<td>2</td>
													<td>Momo</td>
													<td>3 <i id="icon2" class="fas fa-pencil-alt" style="cursor: pointer"></i>
                                                        <input type="text" id="inputField2" class="form-control" autofocus>
                                                    </td>
													<td>4</td>
												...
												<tr>
													...
													<td>3</td>
													<td>Lisa</td>
													<td>7 <i id="icon3" class="fas fa-pencil-alt" style="cursor: pointer"></i>
                                                        <input type="text" id="inputField3" class="form-control" autofocus>
                                                    </td>
													<td>0</td>
    ...
    ***********************************-->
    ...
    <script>
        ...
        inputField2.addEventListener('focusout', function(event) {
    ...
    <script>
        ...
        inputField3.addEventListener('focusout', function(event) {
