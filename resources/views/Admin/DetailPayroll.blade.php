          ...
          <div class="row">
            <div class="col-12">
              <div class="card">
                ...
                <!-- <table>
                    <tr>
                      <th class="kolom">Kolom 1</th>
                      <td class="detail">Detail Kolom 1</td>
                    </tr>
                    <tr>
                      <th class="kolom">Kolom 2</th>
                      <td class="detail">Detail Kolom 2</td>
                    </tr>
                    <tr>
                      <th class="kolom">Kolom 3</th>
                      <td class="detail">Detail Kolom 3</td>
                    </tr>
                  </table> -->
