...
<head>
    ...
    <script type="text/javascript" src="https://app.sandbox.midtrans.com/snap/snap.js" data-client-key="{{config('midtrans.cient_key')}}"></script>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <p>Gaji bulanan 01/05/2023-31/05/2023
                                    <br>Pilih metode pembayaran:</p>
                                </p>
                                ...
                                <p>Langkah pembayaran gaji:
                                    <br>1. Pastikan rekening perusahaan Anda telah ditambahkan. Klik disini untuk menambahkan.
                                    <br>2. Pastikan slip gaji sudah berstatus Siap Bayar. Hanya yang berstatus Siap bayar yang muncul pada file download.
                                    <br>3. Download daftar gaji sesuai bank dari masing-masing karyawan.
                                    <br>4. Lakukan pembayaran gaji ke bank masing-masing
                                    <br>5. Kembali ke halaman ini, dan klik tombol konfirmasi.</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col-sm-2 col-md-2 col-lg-2">
                            <button class="btn btn-outline-light btn-xs ms-3" style="white-space: nowrap;" data-bs-dismiss="modal">Tunggu</button>
                        </div>
                        <div class="col-sm-1 col-md-2 col-lg-2 ms-3">
                            <button id="pay-button" class="btn btn-outline-danger btn-xs ms-1" style="white-space: nowrap;">Bayar Sekarang</button>
                        </div>
                    </div>
                </div>
            </div>
