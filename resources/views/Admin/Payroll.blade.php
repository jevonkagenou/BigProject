                        ...
                        <div class="card-body">
                                    ...
                                    <div class="responsive-button">
                                        <a href="/PayrollStep" class="btn btn-danger btn-xs">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="15" height="15"
                                                fill="white" class="bi bi-caret-right-fill" viewBox="0 0 16 16">
                                                <path
                            ...
                            <div class="row mt-2">
                                ...
                                <div class="col-md-1 col-sm-5 col-3" style="margin-left: -8%">
                                    <div class="dropdown-basic">
                                        <button class="btn btn-outline-light btn-xs dropdown-toggle"
                            ...
                            <div class="accordion" id="accordion-eleven">
                                <div class="table-responsive mb-2">
                                    <table id="example8" class="display align-content-end" style="min-width: 845px"
                                        data-paging="false">
                                        <thead>
                                        ...
                                        <tbody>
                                            <tr class="text-center">
                                                <td>1</td>
                                                <td class="accordion" id="accord-11One" data-bs-toggle="collapse"
                                                    data-bs-target="#collapse11One" aria-controls="collapse11One"
                                                ...
                                                <td style="text-align: center;">
                                                    <div class="btn-group" role="group"
                                                        ...
                                                        <input type="radio" class="btn-check" name="btnradio1"
                                                            id="btnradio14" checked>
                                                        <label class="btn btn-outline-danger btn-xs"
                                                            for="btnradio14">Belum Siap</label>

                                                        <input type="radio" class="btn-check" name="btnradio1"
                                                            id="btnradio15">
                                                        <label class="btn btn-outline-danger btn-xs"
                                                            for="btnradio15">Siap Bayar</label>

                                                        <input type="radio" class="btn-check" name="btnradio1"
                                                            id="btnradio16">
                                                        <label class="btn btn-outline-danger btn-xs"
                                                            for="btnradio16">Sudah Bayar</label>
                                                    </div>
                                                </td>
                                                <td>2.434.678</td>
                                            </tr>
                                            <tr>
                                                <td colspan="5">
                                                    <div id="collapse11One" class="collapse accordion__body"
                                            ...
                                            <tr class="text-center">
                                                <td>2</td>
                                                <td class="accordion collapsed" id="accord-11Two"
                                                    data-bs-toggle="collapse" data-bs-target="#collapse11Two"
                                                    aria-controls="collapse11Two" aria-expanded="true"
                                                    role="button">
                                                    Dwi
                                                </td>
                                                <td>BCA</td>
                                                <td style="text-align: center;">
                                                    <div class="btn-group" role="group"
                                                        ...
                                                        <label class="btn btn-outline-danger btn-xs"
                                                            for="btnradio17">Belum Siap</label>

                                                        <input type="radio" class="btn-check" name="btnradio2"
                                                            id="btnradio18">
                                                        <label class="btn btn-outline-danger btn-xs"
                                                            for="btnradio18">Siap Bayar</label>

                                                        <input type="radio" class="btn-check" name="btnradio2"
                                                            id="btnradio19">
                                                        <label class="btn btn-outline-danger btn-xs"
                                                            for="btnradio19">Sudah Bayar</label>
                                                    </div>
                                                </td>
                                                <td>2.434.678</td>
                                            </tr>
