...
<body>
    ...
    <style>
        ...
        .tambah-baris {
            margin-bottom: 20px;
            /* Jarak antara tombol "Tambah Baris" dan baris pertama */
        }

        .shift {
            margin-left: 10px;
            /* Menambahkan jarak ke kiri pada elemen dropdown */
            margin-top: -1px;
        }

        .hapus-baris {
            margin-left: 10px;
            /* Menambahkan jarak ke kiri pada ikon hapus */
            margin-top: 8px;
        ...
        <script>
            $(document).ready(function() {
                ...
                function tambahBaris() {
                    ...
                    if (jumlahBaris >= 8) {
                        // Mencapai batas maksimal hari ke-7
                        return;
                    }
                    var htmlBaris =
                        '<div class="baris" style="display: flex; justify-content: align-items: center;">' +
