                                    ...
                                    <table id="example5" class="display" style="min-width: 845px">
                                        ...
                                        <tbody class="text-center">
                                            <tr>
                                                ...
                                                <td>5</td>
                                                <td><a href="/Payroll"><div class="progress" role="progressbar" style="height: 15px !important;" aria-label="Danger example" aria-valuenow="100" aria-valuemin="0" aria-valuemax="100">
