                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" id="tempatlahir" placeholder="Nama"
                                    value="" required="">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" id="tempatlahir" placeholder="Lama Periode"
                                    value="" required="">
                                <div class="invalid-feedback">
                                    Valid first name is required.
                                </div>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="date" class="form-control" id="tempatlahir" placeholder=""
                                    value="" required="">
                                <div class="invalid-feedback">
                                    Valid first name is required.
                                </div>
                        ...
                        <div class="mb-3">
                            <label for="address2" class="form-label">Untuk komponen pendapatan tergantung kehadiran,
                                berapa hari absensi terakhir yang masuk hitungan<span class="text-muted"></span></label>
                            <input type="text" class="form-control" id="address2"
                                placeholder="Masukkan jumlah hari (Masukkan sebelum akhir periode)">
                        </div>
                    </div>
                        ...
                        <div class="row form-material">
                                ...
                                <div class="card card-cd">
                                    ...
                                    <div class="card-body ">
                                        ...
                                        <button type="button" class="btn btn-danger btn-xs" data-bs-toggle="modal"
                                            data-bs-target=".modal-5"><i class="fa fa-plus color-info"></i>
                            ...
                            <div class="col-lg-6">
                                <div class="card card-cd">
                                    <div class="card-header d-block">
                                        <b>
                                            <h4 class="card-title" style="text-align: center;">Komponen Pemotongan
                                            </h4>
                                        </b>
                                    </div>
                                    <div class="card-body">
                                        ...
                                        <hr>
                                        <button type="button" class="btn btn-danger btn-xs" data-bs-toggle="modal"
                                            data-bs-target=".modal-6"><i class="fa fa-plus color-info"></i>
                                            <span class="text-center">
