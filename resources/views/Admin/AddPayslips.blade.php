        ...
        <div class="dlabnav">
            <div class="dlabnav-scroll mm-active ps ps--active-y">
                <ul class="metismenu mm-show" id="menu">
                    ...
                    <li class="mm-active"><a class=" ai-icon hover-red mm-active" href="/Setting "
                            aria-expanded="true">
    ...
    $(document).ready(function() {
        ...
        function tambahBaris() {
            ...
            var htmlBaris =
                ...
                '<input type="text" class="form-control @error('nama_komponendpt') is-invalid @enderror" id="nama_komponendpt" name="nama_komponendpt[]" placeholder="Nama Komponen Dapat">' +
                '@error('nama_komponendpt')' +
                '<div class="invalid-feedback">{{ $message }}</div>' +
                '@enderror' +
                '</div>' +
                '<div class="col-3">' +
    ...
    $(document).ready(function() {
        ...
        function tambahBaris2() {
            ...
            var htmlBaris =
                ...
                '<input type="text" class="form-control @error('nama_komponenptg') is-invalid @enderror" id="nama_komponenptg" name="nama_komponenptg[]" placeholder="Nama Komponen Dapat">' +
