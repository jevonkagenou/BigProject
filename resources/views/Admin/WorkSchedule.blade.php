            ...
            <div class="dlabnav-scroll">
                <ul class="metismenu" id="menu">
                    ...
                    <li><a class="has-arrow ai-icon hover-red" href="javascript:void()" aria-expanded="false">
                        <svg class="red-icon" class="svg" xmlns="http://www.w3.org/2000/svg" height="48"
                            ...
                            <div class="card-body">
                                ...
                                <div style="margin-right: 3%; ">
                                    <button type="button" class="btn btn-danger btn-xs" id="actionButton"
                                        style="display: none;" data-bs-toggle="modal" data-bs-target=".modal-6">
                                                ...
                                                <th>
                                                    <div class="form-check custom-checkbox ms-2">
                                                        <input type="checkbox" id="select-all-checkbox"
                                                            class="form-check-input" style="color: #f84062;"> <label
                                                            class="form-check-label" for="selectall"></label>
                                                    </div>
                                                </th>
                                                <th>Nama</th>
                                                <th>Nama Jadwal</th>
                                        ...
                                        <tbody>
                                            ...
                                            @foreach ($data as $row)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="form-check custom-checkbox ms-2">
                                                            <input type="checkbox" name="myCheckbox[]" id="select-all-btn" value="{{ $row->id }}"
                                                                class="other-checkbox form-check-input"
                                                                style="color: #f84062;">
                                                ...
                                                <div class="modal modal{{ $row->id }} fade"
                                                    id="updatejadwalkerja">
                                                    <div class="modal-dialog modal-dialog-centered" role="document">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                            ...
                                                            <div class="modal-body">
                                                                <form id="editForm"
                                                                    action="/updatejadwalkerja/{{ $row->id }}"
                                                                    method="POST">
                                                                    @csrf
                                                                    <div class="row g-0">
                                                                        <label for="nama_jadwal"
                                                                ...
                                                                <div class="row g-0">
                                                                        <label for="nama_jadwal"
                                                                            class="form-label">Nama Jadwal</label>
                                                                        <div class="col">
                                                                            <select id="tom-select-it"
                                                                                name="nama_jadwal"
                                                                                value="{{ $row->nama_jadwal }}"
                                                                                class="default-select form-control wide w-100">
                                                                                <option value="shift pagi"
                                                                                    {{ $row->nama_jadwal == 'shift pagi' ? 'selected' : '' }}>
                                                                                    Shift Pagi</option>
                                                                                <option value="Shift Malam"
                                                                                    {{ $row->nama_jadwal == 'Shift Malam' ? 'selected' : '' }}>
                                                                                    Shift Malam</option>
                                                                                <option value="3"
                                                                                    data-url="/AddWorkSchedule">Tambah
                                                                                    Jadwal</option>
                                                                            </select>
                                                                        </div>
                                                                    </div>
                        ...
                        <div class="modal-body">
                            <form id="editFormSchedule" action="/updatejadwal" method="POST">
                                ...
                                <div class="row g-0">
                                    ...
                                    <select id="tom-select-it" name="nama_jadwal"
                                        class="default-select form-control wide w-100">
    ...
    $(document).ready(function() {
        ...
        $('#btnDiterima').on('click', function() {
            ...
            if (checkedIds.length > 0) {
                var url = '{{ route('updatejadwal', ['id' => ':id']) }}'.replace(':id', checkedIds[0]);
