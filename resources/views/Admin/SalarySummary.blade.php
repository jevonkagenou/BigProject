                                    ...
                                    <div class="col-xl-2 col-lg-2 col-md-2 col-sm-4 col-4 me-auto">
                                        <div class="responsive-button">
                                            <div class="basic-dropdown">
                                                <div class="dropdown">
                                                    <button type="button" class="btn btn-outline-light btn-xs dropdown-toggle" data-bs-toggle="dropdown"><span>
                                                            <i class="bi bi-arrow-bar-up px-1"></i>
                                                        </span>
                                                        Ekspor
                                                    </button>
                                                    <div class="dropdown-menu">
                                                        <a class="dropdown-item" href="#"><span class="px-2"><i class="bi bi-file-earmark-excel"></i></span>XCLS</a>
                                                        <a class="dropdown-item" href="#"><span class="px-2"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-file-earmark-pdf" viewBox="0 0 16 16">
