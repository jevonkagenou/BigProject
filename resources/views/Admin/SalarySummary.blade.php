            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active"><a href="">Ringkasan Gaji</a></li>
                    </ol>
                </div>
                <div class="row">
                    <div class="col-12">
                                    ...
                                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                                        ...
                                        {{-- <div class="col-xl-2 col-lg-2 col-md-2 col-sm-4 col-4 me-auto">
                                            <form action="{{route('ExportEmployee')}}" method="post" enctype="multipart/form-data">
                                                @csrf
                                                <div class="col-sm-1 col-md-2 col-lg-2 text-start" style="white-space: nowrap;">
                                                    <button class="btn btn-outline-light btn-xs ms-1 mt-3"
                                                            style="white-space: nowrap;" name="import"><i class="bi bi-upload"></i> Export</button>
                                                </div>
                                            </form>
                                        </div> --}}
                                    </div>
