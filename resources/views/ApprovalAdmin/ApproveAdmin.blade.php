        ...
        <div class="dlabnav">
            <div class="dlabnav-scroll">
                <ul class="metismenu" id="menu">
                    ...
                    <li class="red-hover"><a class="has-arrow ai-icon hover-red" href="javascript:void()" aria-expanded="false">
