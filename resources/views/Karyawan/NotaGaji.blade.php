			...
			<div class="container-fluid">
				<div class="row">
					<div class="col-xl- col-xl-12">
						...
						<div class="row">
							<div class="col-md-4 mb-4" name="ellipsis-vertical-outline;" style="margin-bottom: 20px;">
								<div class="card progress-card">
									<p>
									<div class ="img_cont" >
										<center><img src="images/bank3.png" class="rounded-circle user_img" alt="width=30%"/></center>
										<span class="online_icon"></span>
									</div>
									<div class="card-body d-flex; justify-content: center;" >
                                        ...
                                        <div class="jihan-fira" style="margin-top: 2%;"  >
                                            ...
                                            <p class="gray-text">Total Potongannn : 50.000</p>
                                        </div>
                                        <hr>
                                        <div class="hitam">
										...
										<button type="button" class="btn btn-rounded btn-danger" style="font-size: 14px;">Cetak Bukti Pembayaran</button>
									</div>
								</div>
							</div>
							<div class="col-md-4 mb-4" name="ellipsis-vertical-outline;" style="margin-bottom: 20px;">
								<div class="card progress-card">
									<p>
									<div class ="img_cont ms-auto" >
										<img src="images/bank3.png" class="rounded-circle user_img" alt="width=30%"/>
										<span class="online_icon"></span>
									</div>
									<div class="card-body d-flex; justify-content: center;" >
										<div class="me-auto">
                                        ...
                                        <div class="hitam">
											...
											<p class="THP">Rp. 2.450.000</p>
											<button type="button" class="btn btn-rounded btn-danger" data-bs-toggle="modal" data-bs-target=".bd-example-modal-xl" style="font-size: 14px;">Cetak Bukti pembayaran</button>
											<!-- Modal -->
