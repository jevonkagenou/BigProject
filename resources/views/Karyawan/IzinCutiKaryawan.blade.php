            ...
            <div class="container-fluid">
                ...
                <div class="row">
								...
								<div class="row">
									...
									<div class="col-xl-3 col-lg-4 col-md-4 col-sm-6 col-12 mt-2">
										<!-- <div class="col-lg-4 col-12  text-end"> -->
											<button type="button" class="btn btn-danger btn-xs" data-bs-toggle="modal" data-bs-target=".bd-example-modal-lg"><i class="fa fa-plus color-info"></i>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
								<div class="row">
									...
									<div class="col-xl-3 col-lg-4 col-md-4 col-sm-6 col-12 mt-2">
										<!-- <div class="col-lg-4 col-12  text-end"> -->
											<button type="button" class="btn btn-danger btn-xs" data-bs-toggle="modal" data-bs-target=".modal-2"><i class="fa fa-plus color-info"></i>
												<span class="text-center">
												Tambah Pengajuan
												</span>
											</button>
					...
					<div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-body">
								<div class="row">
									...
									<div class="col-xl-3 col-lg-4 col-md-4 col-sm-6 col-12 mt-2">
										<!-- <div class="col-lg-4 col-12  text-end"> -->
											<button type="button" class="btn btn-danger btn-xs" data-bs-toggle="modal" data-bs-target=".modal-3"><i class="fa fa-plus color-info"></i>
												<span class="text-center">
												Tambah Pengajuan
												</span>
											</button>
						 ...
						 <div class="modal-dialog modal-dialog-centered modal-lg">
							 <div class="modal-content">
								 ...
								 <div class="modal-footer">
									 <button type="button" class="btn btn-danger light btn-xs" data-bs-dismiss="modal">Close</button>
					 ...
					 <div class="modal modal-2 fade bd-example-modal-lg" tabindex="-1" role="dialog" aria-hidden="true">
						<div class="modal-dialog modal-dialog-centered modal-lg">
							<div class="modal-content">
								<div class="modal-header">
					 ...
					 <div class="modal modal-3 fade bd-example-modal-lg" tabindex="-1" role="dialog" aria-hidden="true">
						<div class="modal-dialog modal-dialog-centered modal-lg">
							<div class="modal-content">
								<div class="modal-header">
