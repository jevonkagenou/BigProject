    ...
    ***********************************-->
    <div id="main-wrapper">
        ...
        <!--**********************************
            Nav header start
        ***********************************-->
       <div class="nav-header" style="background-color: #f72b50">
            ...
            <div class="nav-control">
                <div class="hamburger text-white">
                    <span class="line text-white"></span><span class="line text-white"></span><span class="line text-white"></span>
                </div>
            </div>
        </div>
        <!--**********************************
        ...
        <div class="dlabnav bg-danger text-white">
            <div class="dlabnav-scroll">
				...
				<div class="copyright">
					...
					<p class="fs-12 text-white">Made with <span class="heart" style="color: white"></span> by Kalopsia</p>
				</div>
			</div>
        </div>
        <!--**********************************
