                    ...
                    <ul class="navbar-nav header-right">
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end" style="margin-left:-100%;">
                                <li><a class="dropdown-item" href="/ProfilAdmin/1"><svg xmlns="http://www.w3.org/2000/svg"
    ...
    <div class="dlabnav">
        <div class="dlabnav-scroll  mm-active ps ps--active-y">
            <ul class="metismenu  mm-show" id="menu">
                ...
                @endif
                @if ($tittle == "Laporan")
                <li class="mm-active"><a class="ai-icon red-hover " href="/AdminReport" aria-expanded="false">
                    <svg class="svg red-icon" xmlns="http://www.w3.org/2000/svg" height="48" viewBox="0 -960 960 960" width="48"><path
                ...
                <li class="mm-active"><a class=" ai-icon  red-hover" href="/Setting" aria-expanded="false">
                        <svg class="svg red-icon" xmlns="http://www.w3.org/2000/svg" height="48" viewBox="0 -960 960 960"
                            width="48">
                            <path
