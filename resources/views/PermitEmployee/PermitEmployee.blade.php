                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="mb-2 d-flex">
                                        ...
                                        <div class="col-xl-9 col-lg-8 col-md-8 col-sm-12 col-12 btn-group btn-xs ms-auto">
                                            <!-- <div class="btn-group  col-lg-8  col-12"> -->
                                                <div class="size-filter">
                                                    <div class="btn-group btn-xs" role="group" aria-label="Basic radio toggle button group">
                                                      <input type="radio" class="btn-check" name="btnradio" id="btnradio1" checked>
                                                      <label class="btn btn-outline-danger btn-xs btn-hover" for="btnradio1">Cuti Khusus</label>

                                                      <input type="radio" class="btn-check" name="btnradio" id="btnradio2">
                                                      <label class="btn btn-outline-danger btn-xs btn-hover" for="btnradio2">Izin</label>
