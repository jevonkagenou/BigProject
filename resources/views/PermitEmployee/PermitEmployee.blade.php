                                        ...
                                        <div class="col-xl-9 col-lg-8 col-md-8 col-sm-12 col-12 btn-group btn-xs">
                                            <!-- <div class="btn-group  col-lg-8  col-12"> -->
                                                <div class="size-filter">
                                                    <div class="btn-group btn-sm" role="group" aria-label="Basic radio toggle button group">
                                                      <input type="radio" class="btn-check" name="btnradio" id="btnradio1" checked>
                                                      <label class="btn btn-outline-danger btn-sm btn-hover" for="btnradio1">Cuti Khusus</label>

                                                      <input type="radio" class="btn-check" name="btnradio" id="btnradio2">
                                                      <label class="btn btn-outline-danger btn-sm btn-hover" for="btnradio2">Izin</label>

                                                      <input type="radio" class="btn-check" name="btnradio" id="btnradio3">
                                                      <label class="btn btn-outline-danger btn-sm" for="btnradio3">Sakit</label>
                                                    </div>
