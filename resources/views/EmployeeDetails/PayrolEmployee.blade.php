                                    ...
                                    <div style="">
                                        <div class="dropdown-container d-flex justify-content-center">
                                            <div class="edit-overlay">
                                                <img src="{{ asset('images/' . $data->images) }}" class="edit-image"
                                        ...
                                        <div style="text-align: center;">
                                            <h4 class="text-black">{{ $data->longname }}</h4>
                                        ...
                                        <div class="container">
                                            <div class="row justify-content-center"
                                                ...
                                                <input type="radio" class="btn-check" name="btnradio1a"
                                                    id="btnradio1a" >
                                                <a href="/Employee/{{ $data->id }}" type="button"
                                                ...
                                                <a href="/PayrolEmployee/{{ $data->id }}" type="button"
                                                    ...
                                                    style="width: 200px;">Riwayat Gaji</a>
                                            </div>
                                        </div>
