                ...
                <div class="row">
                    <div class="col-xl-12">
                        <div class="card">
									...
									<div class="card-body col-xl-3 col-lg-4 col-md-4 col-sm-4 ml-8">
										<div style="">
											<div class="profile-photo d-flex justify-content-center">
												<img src="images/profile/profile.png" class="img-fluid rounded-circle " alt=""></div>
												<br>
												...
												<div class="d-flex mb-1">
													<a href="javascript:void(0);" class="btn btn-danger btn-xs col-6 col-md-10 col-sm-10 mx-auto"><i class="bi bi-person-circle me-3"></i>Personal</a>
												</div>
												<div class="d-flex mb-1">
													<a href="javascript:void(0);" class="btn btn-danger btn-xs col-6  col-md-10 col-sm-10 mx-auto"><i class="bi bi-card-list me-3"></i>Payroll</a>
												</div>
												<div class="d-flex mb-2">
													<a href="javascript:void(0);" class="btn btn-danger btn-xs col-6 col-md-10 col-sm-10 mx-auto"><i class="bi bi-trash me-3"></i>Hapus Data Karyawan</a>
												</div>
                            ...
                            <div class="card-body col-xl-6 col-lg-8 col-md-8 col-sm-8 col-12">
                                <div class="row">
                                    ...
                                    <div class="col-lg-12 order-lg-1">
                                        ...
                                        <form class="needs-validation" novalidate="">
                                            ...
                                            <div class="form-check custom-checkbox mb-1">
                                                <label class="form-check-label text-black text-strong" for="same-address">Informasi Pribadi</label>
                                            </div>
											<hr class="mb-2">
											<div class="row mb-1">
												<div class="col-3">
										...
										<div class="col-8">
											<div class="form-check custom-checkbox ml-8 ">
                                                <label class="form-check-label" for="save-info">Ananda Harfiana</label>
                                            </div>
										</div>
										</div>
                                            <hr class="mb-2">
										...
										<div class="col-7">
											...
											<div class="row mb-1">
												<div class="col-3">
                                            <div class="form-check custom-checkbox ">
                                                <label class="form-check-label" for="save-info">Tanggal Lahir</label>
                                            </div>
										</div>
										<div class="col-1">
											<div class="form-check custom-checkbox ">
										...
										<div class="col-7">
											...
											<div class="row mb-1">
												<div class="col-3">
                                            <div class="form-check custom-checkbox ">
                                                <label class="form-check-label" for="save-info">Status Perkawinan</label>
                                            </div>
										</div>
										<div class="col-1">
											<div class="form-check custom-checkbox ">
										...
										<div class="col-7">
											<div class="form-check custom-checkbox ml-8 ">
                                                <label class="form-check-label" for="save-info">Belum Menikah</label>
                                            </div>
										</div>
										</div>
											<hr class="mb-2">
											<div class="row mb-1">
												<div class="col-3">
                                            <div class="form-check custom-checkbox ">
                                                <label class="form-check-label" for="save-info">Golongan Darah</label>
                                            </div>
										</div>
										<div class="col-1">
											<div class="form-check custom-checkbox ">
										...
										<div class="col-7">
											...
											<hr class="mb-2">
											<div class="form-check custom-checkbox mb-1">
                                                <label class="form-check-label  text-black text-strong" for="save-info">Informasi Kontak</label>
											</div>
											<hr class="mb-2">
											<div class="row mb-1">
												<div class="col-3">
										...
										<div class="col-7">
											<div class="form-check custom-checkbox ml-8 ">
                                                <label class="form-check-label" for="save-info">anandaharfiana@gmail.com</label>
                                            </div>
										</div>
										</div>
											<hr class="mb-2">
										...
										<div class="col-7">
											<div class="form-check custom-checkbox ml-8 ">
                                                <label class="form-check-label" for="save-info">085794335045</label>
                                            </div>
										</div>
										</div>
											<hr class="mb-2">
										...
										<div class="col-7">
											<div class="form-check custom-checkbox ml-8 ">
                                                <label class="form-check-label" for="save-info">Jl. Kemiri City/Tokyo</label>
                                            </div>
										</div>
									</div>
											<hr class="mb-2">
											<div class="form-check custom-checkbox mb-1">
                                                <label class="form-check-label  text-black text-strong" for="save-info">Pendidikan Terakhir</label>
											</div>
											<hr class="mb-2">
											<div class="row mb-1">
												<div class="col-3">
                                            <div class="form-check custom-checkbox ">
                                                <label class="form-check-label" for="save-info">Jenjang Pendidikan Terakhir</label>
                                            </div>
										</div>
										<div class="col-1">
											<div class="form-check custom-checkbox ">
										...
										<div class="col-7">
											<div class="form-check custom-checkbox ml-8 ">
                                                <label class="form-check-label" for="save-info">S.Kom., S.Psi.</label>
                                            </div>
										</div>
										</div>
											<hr class="mb-2">
											<div class="row mb-1">
												<div class="col-3">
                                            <div class="form-check custom-checkbox ">
                                                <label class="form-check-label" for="save-info">Program Studi</label>
                                            </div>
										</div>
										<div class="col-1">
											<div class="form-check custom-checkbox ">
										...
										<div class="col-7">
											<div class="form-check custom-checkbox ml-8 ">
                                                <label class="form-check-label" for="save-info">Rekayasa Perangkat Lunak</label>
                                            </div>
										</div>
										</div>
											<hr class="mb-2">
											<div class="row mb-1">
												<div class="col-3">
                                            <div class="form-check custom-checkbox ">
                                                <label class="form-check-label" for="save-info">Nama Institusi Pendidikan</label>
                                            </div>
										</div>
										<div class="col-1">
											<div class="form-check custom-checkbox ">
										...
										<div class="col-7">
											<div class="form-check custom-checkbox ml-8 ">
                                                <label class="form-check-label" for="save-info">SMKN 1 Purwosari</label>
                                            </div>
										</div>
										</div>
